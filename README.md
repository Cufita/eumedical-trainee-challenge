...
**Metodología.** Encaré el reto con una estrategia SDD (spec-driven): el Brand Book, el brief del challenge (`docs/brand/Eumedical_Trainee_Challenge.docx.pdf`) y el `package.json` de partida funcionaron como la especificación base a partir de la cual construí toda la guía de dirección visual y de producto, antes de tocar un componente. Usé **Cloud Design** para el boceto principal y **Figma Make** para generar assets y guías visuales de apoyo.
