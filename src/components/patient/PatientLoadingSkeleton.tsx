...
// way in (see AppShell) — flat gray shapes tracing the shell it's about to
// become, shimmering like Instagram/Facebook/X skeletons. No logo, no copy:
// the shapes alone read as "loading".
