    ...
    >
      {links.map(({ href, key }, index) => (
        <a
          ...
          className={`rounded-xl px-3 py-3 text-[15px] text-navy/90 transition-[color,background-color,opacity,transform] duration-200 ease-out hover:bg-navy/[0.04] hover:text-gold motion-reduce:transition-none motion-reduce:max-md:translate-x-0 motion-reduce:max-md:opacity-100 md:px-3 md:py-2 md:text-[14.5px] ${
